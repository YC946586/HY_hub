...
namespace InstallPackage
{
    public class LocalInstallTesting
    {
        ...
        /// 控制面板显示名称
        /// </summary>
        public const string ControlPanelDisplayName = "黑鹰 Hub";
        /// <summary>
        /// 程序版本
        /// </summary>
        ...
        /// 卸载程序名称（必须包含在压缩包内）
        /// </summary>
        public const string UninstallExe = "HY.UninstallPackage.exe";
        /// <summary>
        /// 显示名称
        /// </summary>
        public const string DisplayName = "黑鹰 Hub";
        /// <summary>
        /// 注册应用信息
        /// </summary>
        ...
        { 
            Stream stream = System.Windows.Application.GetResourceStream(new Uri(@"/HY.InstallPackage;component/Resources/" + sourceFile, UriKind.Relative)).Stream;
        ...
        public static void CopyAllFile(string targetPath, Action<int> progress)
        {
            ...
            progress(85);
            DirectoryInfo folder = new DirectoryInfo(@"../../Resources");
            ...
            //CopyFile(targetPath, "HY Main.exe.config");
            RegeditGuid = Guid.NewGuid().ToString();
            Configuration config = ConfigurationManager.OpenExeConfiguration(targetPath + "\\HY Main.exe");
        ...
        public static void CreateShortcut(string targetFile)
        {
            ...
            shortcut.TargetPath = targetFile + "\\HY Main.exe";
        ...
        public static void CreateProgramsShortcut(string targetPath, string menuName)
        {
            ...
            shortcut.TargetPath = targetPath + "\\HY Main.exe";
        ...
        public static void CreateProgramsUninstallShortcut(string targetPath, string menuName)
        {
            ...
            var shortcut = shell.CreateShortcut(startMenu + "\\卸载黑鹰 Hub.lnk");
